...
const Navbar = () => {
  ...
  const logout = async () => {
    await fetch("https://to-do-list-git-main-subhoxsahas-projects.vercel.app/logout", {
      method: "POST",
      credentials: "include",
    })
      .then((response) => {
  ...
  useEffect(() => {
    fetch("https://to-do-list-git-main-subhoxsahas-projects.vercel.app/profile", { credentials: "include" })
